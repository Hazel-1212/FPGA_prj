...
HD_PWD='C:/03 Digital Lab/Lab08/light_show/light_show.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log light_show.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source light_show.tcl -notrace

...
HD_PWD='C:/03 Digital Lab/Lab08/light_show/light_show.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log light_show.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source light_show.tcl

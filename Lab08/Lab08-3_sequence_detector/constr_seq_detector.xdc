...
#set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { sender }]; #IO_L19P_T3_35 Sch=jc[4]
...
#set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { receiver }]; #IO_L20N_T3_35 Sch=jd[4]

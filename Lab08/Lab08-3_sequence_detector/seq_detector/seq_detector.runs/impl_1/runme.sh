...
HD_PWD='C:/03 Digital Lab/Lab08/Lab08-3_sequence_detector/seq_detector/seq_detector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_detector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seq_detector.tcl -notrace

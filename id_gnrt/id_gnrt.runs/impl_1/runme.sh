...
HD_PWD='C:/03 Digital Lab/Lab05/id_gnrt/id_gnrt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log id_src.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source id_src.tcl -notrace

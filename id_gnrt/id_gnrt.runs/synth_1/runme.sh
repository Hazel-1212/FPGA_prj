...
HD_PWD='C:/03 Digital Lab/Lab05/id_gnrt/id_gnrt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log id_src.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source id_src.tcl

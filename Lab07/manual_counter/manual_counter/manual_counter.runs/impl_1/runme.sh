...
HD_PWD='C:/03 Digital Lab/Lab07/manual_counter/manual_counter/manual_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log manual_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source manual_counter.tcl -notrace

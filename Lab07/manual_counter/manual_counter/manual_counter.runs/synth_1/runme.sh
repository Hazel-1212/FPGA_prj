...
HD_PWD='C:/03 Digital Lab/Lab07/manual_counter/manual_counter/manual_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log manual_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source manual_counter.tcl

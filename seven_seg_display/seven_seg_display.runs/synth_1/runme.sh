...
HD_PWD='C:/03 Digital Lab/Lab05/seven_seg_display/seven_seg_display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_an_cnt_dgt_disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_an_cnt_dgt_disp.tcl

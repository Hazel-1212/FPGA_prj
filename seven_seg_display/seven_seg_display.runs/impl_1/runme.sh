...
HD_PWD='C:/03 Digital Lab/Lab05/seven_seg_display/seven_seg_display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_an_cnt_dgt_disp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_an_cnt_dgt_disp.tcl -notrace

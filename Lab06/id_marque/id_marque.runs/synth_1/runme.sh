...
HD_PWD='C:/03 Digital Lab/Lab06/id_marque/id_marque.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log id_marquee.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source id_marquee.tcl

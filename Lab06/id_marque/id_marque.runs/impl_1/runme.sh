...
HD_PWD='C:/03 Digital Lab/Lab06/id_marque/id_marque.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log id_marquee.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source id_marquee.tcl -notrace
